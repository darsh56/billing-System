<%-- 
    ...
    Created on : Mar 20, 2015, 3:02:33 PM
    Author     : navkar
--%>
...
<script language="javascript" type="text/javascript">  
      ...
      function selectinvloice(){   
      if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){   
      document.getElementById("InvoiceNo").innerHTML=xmlHttp.responseText   
      }   
      }
</script>
<script language="javascript" type="text/javascript">  
...
<div id="main_container">
   ...
   <div class="left_content">
    ...
    <div class="right_content"> 
         ...
         <h1> Add Invoice Report Details </h1>
            
         <div class="form">
         <form action="./Report_Invoice" method="post">             
                   <table>                       
                    <tr>
                        <td><label for="I_Type"> Invoice Type: </label></td>
                        <td>
                            <select  name="I_Type" id="I_Type" style="width:200px;height:30px;" required="" onchange="toggleMe1(this.value);showinvono(this.value)">
                    ...
                    <tr>
                        <td><label for="FormType">FormType: </label> </td>
                        <td>
                            <select name="FormType" id="formtype" style="width:200px;height:30px;" onchange="showRetailno(this.value)" data-validation-engine="validate[required,custom[onlyNumberSp]]" >
                                <option value=""> Select Form </option>
                                <option value="Against C Form"> Against C Form </option>
                                <option value="W/O Against C Form"> W/O Against C Form </option>
                                <option value="Against H Form"> Against H Form </option>                   
                            </select>
                        </td>
                    </tr>    
                    <tr>
                    <td><label for="InvoiceNo">InvoiceNO: </label> </td>
                    <td>
                        <select name="InvoiceNo" id="InvoiceNo" style="width:200px;height:30px;" required="">
                            <option value=""> Select InvoiceNo Number </option>
                        </select>
                    </td>
                   </tr>
             <tr>
                 <td></td>
                 <td class="continue"><input type="submit" name="Submit"  value="Submit" /></tdcount>
             </tr>
                   </table>
         </form>
         </div>
