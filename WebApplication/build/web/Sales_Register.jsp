<%-- 
    Document   : Sale_Register
    Created on : Apr 11, 2015, 12:20:31 PM
    Author     : navkar
--%>
<%@page import="com.Bean.Sales_Register_Bean"%>
...
<div class="center_content">     
   ...
   <div class="form">
           ...
           <h1 align="left">Sale Register</h1>
	   <table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
                                   <%
                                        String msg=(String)request.getAttribute("export");
                                        if(msg!=null){
                                   %>
					<td class="green-left"><b style="color:#33ff33;">&Sqrt;</b>&nbsp;<%=msg%></td>
			          <%}%>
                                </tr>
          </table>
        ...
        <table border="0" style="width: 210px;">
            <td>           
            <form action="./Export_Sales_Register" method="get" >
                <table border="0" cellpadding="0" cellspacing="0"  id="id-form" >		
                    <tr>
                        <td valign="top">
                        <input type="submit" value="Export Sale Register"  />
                        </td>
                    </tr>
                </table>
          </form>
