...
<%-- 
    Document   : Jobwork
    Created on : Mar 13, 2015, 3:30:59 PM
    Author     : navkar
--%>
...
function st()
{
    ...
    var ct=Number(document.getElementById("st1").value);
...
{
    //alert("sddss");
    var ct=Number(document.getElementById("ec1").value);
...
{
    //alert("sddss");
    var ct=Number(document.getElementById("hec1").value);
    var st2=Number(document.getElementById("st2").value);
...
function Aamount()
{
    //alert("hh");
    var st2=Number(document.getElementById("st2").value);
    var ec2=Number(document.getElementById("ec2").value);
    var hec2=Number(document.getElementById("hec2").value);
    //var ta=Number(document.getElementById("toa").value);
    
    var cst=st2+ec2+hec2+toa;
    //alert(cst);
    aamount.value=cst;
}
function Roundoff()
                ...
                <form action="Insert_Job"  method="post">
                     <table cellpadding="5">
                       <tr>
                            ...
                            <td>
                                  <td> JobNo: </td>
                                  <td> <input type="text" name="jobno" value="<%=incr%>" style="width:200px;height:30px;" required=""/></td>                                  
                            </td>
                            <td>
                                  <td> DCNNo: </td>
                                  <td> <input type="text" name="dcnno" value="<%=dcnno%>" style="width:200px;height:30px;" required=""/></td>  
                           </td>                            
                        </tr>                         
                        <tr>
                            <td>
                                  ...
                                  <td>
                                       <%
                                        ...
                                        %>	
                                        <input type="text" name="compname"  value="<%=cname%>" style="width:200px;height:30px;" required="" readonly=""/>
                                  </td>
                                   <%}}%>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                    <td> BE No:</td>
                                    <td> <input type="text" name="beno" value="0" style="width:200px;height:30px;" required="" /></td>
                            </td>
                            <td>
                                  <td> Courier Charge: </td>
                                  <td> <input type="text" name="couriercharge" onkeyup="add();" id="cc" style="width:200px;height:30px;" required="" /></td>
                            </td>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td>
                                    <td> Tr.Ch.No: </td> 
                                    <td> <input type="text" name="trchno" value="0" style="width:200px;height:30px;" required="" /></td>
                            </td>
                            <td>
                                    <td> Sertax: </td> 
                                    <td> <input type="text" name="sertax1" id="st1" onkeyup="st();" value="0" style="width:200px;height:30px;" required="" />
                                    <input type="text" id="st2" readonly=""name="sertax2" style="width:200px;height:30px;" required=""/></td>
                            </td>
                        </tr>                        
                         <tr>
                             <td>
                            ...
                            <td>
                                     <td> Educess: </td> 
                                    <td> <input type="text" name="Educess1" onkeyup="Eduscess();" id="ec1" value="0" style="width:200px;height:30px;" required=""/>
                                    <input type="text" id="ec2" name="Educess2" readonly="" style="width:200px;height:30px;" required=""/></td>
                            </td>                            
                        </tr>                          
                        <tr>
                            <td>
                             ...
                             <td>
                                    <td> HiEducess: </td> 
                                    <td> <input type="text" name="HiEducess1" size="30" id="hec1"onkeyup="Hieduscess();Aamount();Roundoff();Netamount();convert_amount_into_rupees_paisa();" value="0" style="width:200px;height:30px;" required=""/>
                                    <input type="text"id="hec2" name="HiEducess2"  readonly="" style="width:200px;height:30px;" required=""/></td>
                            </td>
                        </tr>                        
                        <tr>
                             <td>
                                   <td> Affamount </td> 
                                    <td> <input type="text" name="Affamount" id="aamount" readonly="" required="" style="width:200px;height:30px;"/> </td>
                            </td>
                            <td>
                                    <td> Round off: </td> 
                                    <td> <input type="text" name="roundoff" value="" id="roff" style="width:200px;height:30px;" readonly="" required=""/> </td>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                    <td> Net Amount: </td> 
                                    <td> <input type="text" name="netamount" size="30" id="netamount"  readonly="" style="width:200px;height:30px;" required=""/> </td>
                            </td>
                            <td>
                                    <td> </td> 
                                    <td> <input type="text" name="netword"  required="" id="container" style="width:200px;height:30px;" required=""/>   </td>
                            </td>                            
                        </tr>
                        <tr>
                            <td>
