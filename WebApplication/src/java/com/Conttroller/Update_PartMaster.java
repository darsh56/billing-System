...
public class Update_PartMaster extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String pno = request.getParameter("partno");
            ...
            pb.setPartid(pid);
            pb.setPartNo(pno);
            pb.setPartName(pname);
            pb.setDescription(des);
            DBPurchaseOrderForm imp = new DBPurchaseOrderForm();
            boolean b = imp.updatepartmaster(pb);            
            if(b){
                 RequestDispatcher rd = request.getRequestDispatcher("./Select_PartMaster");
