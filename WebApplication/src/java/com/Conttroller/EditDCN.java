...
public class EditDCN extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String partn = request.getParameter("Part_NO");
       ...
       try
       {
            ...
            request.setAttribute("dcnd",dcnd);            
            request.setAttribute("cn",cn);            
            request.setAttribute("en",en);            
            request.setAttribute("ed",ed);            
            request.setAttribute("partn",partn);            
            request.setAttribute("des",des);    
            request.setAttribute("qua",qua);            
            RequestDispatcher rd = request.getRequestDispatcher("DCNForm.jsp");
